...
console.log("Password 1234: ", createHashedPw("1234"));
console.log("Password 1235: ", createHashedPw("1235"));
...
function createHashedPwWithSalt(password) {
...
function comparePw(password, salt) {
  const iterations = 100;
  const keylen = 64;
  const digest = "sha512";
  return crypto
